...
public class DbModFeatures {
	...
	public static final RegistryObject<Feature<?>> PANDORAM = register("pandoram", PandoramFeature::feature,
			new FeatureRegistration(GenerationStep.Decoration.VEGETAL_DECORATION, PandoramFeature.GENERATE_BIOMES, PandoramFeature::placedFeature));
