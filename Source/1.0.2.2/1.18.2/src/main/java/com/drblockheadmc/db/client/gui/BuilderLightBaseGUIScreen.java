...
public class BuilderLightBaseGUIScreen extends AbstractContainerScreen<BuilderLightBaseGUIMenu> {
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 55, this.topPos + 56, 125, 20, new TextComponent("Blank small - soon"), e -> {
		}));
		this.addRenderableWidget(new Button(this.leftPos + 55, this.topPos + 80, 125, 20, new TextComponent("Blank Larg"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 55, this.topPos + 104, 125, 20, new TextComponent("Farms - soon"), e -> {
		}));
		this.addRenderableWidget(new Button(this.leftPos + 55, this.topPos + 128, 125, 20, new TextComponent("Portals- soon"), e -> {
		}));
	}
}
