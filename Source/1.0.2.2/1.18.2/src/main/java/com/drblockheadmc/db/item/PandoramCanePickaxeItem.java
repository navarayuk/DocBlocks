...
public class PandoramCanePickaxeItem extends PickaxeItem {
	public PandoramCanePickaxeItem() {
		super(new Tier() {
			public int getUses() {
				return 4100;
			}
		...
		}, 1, -2.1f, new Item.Properties().tab(DbModTabs.TAB_DB_TOOLS).fireResistant());
	}
}
