...
public class SmoothTardisWallDarkSlabBlock extends DbModElements.ModElement {
	@ObjectHolder("db:smooth_tardis_wall_dark_slab")
	public static final Block block = null;

	public SmoothTardisWallDarkSlabBlock(DbModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_tardis_wall_dark_slab");
		}
