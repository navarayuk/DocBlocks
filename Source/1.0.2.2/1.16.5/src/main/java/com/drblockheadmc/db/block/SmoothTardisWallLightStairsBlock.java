...
public class SmoothTardisWallLightStairsBlock extends DbModElements.ModElement {
	@ObjectHolder("db:smooth_tardis_wall_light_stairs")
	public static final Block block = null;

	public SmoothTardisWallLightStairsBlock(DbModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_tardis_wall_light_stairs");
		}
