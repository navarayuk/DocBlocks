...
public class TardisMonitorPanelBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_monitor_panel")
	public static final Block block = null;

	public TardisMonitorPanelBlock(DbModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).setLightLevel(s -> 7).notSolid()
					.setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("tardis_monitor_panel");
		}
