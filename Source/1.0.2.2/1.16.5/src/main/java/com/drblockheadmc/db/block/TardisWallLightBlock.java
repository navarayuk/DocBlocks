...
public class TardisWallLightBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_light")
	public static final Block block = null;

	public TardisWallLightBlock(DbModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_light");
		}
