...
public class SugarCubeItem extends DbModElements.ModElement {
	@ObjectHolder("db:sugar_cube")
	public static final Item block = null;

	public SugarCubeItem(DbModElements instance) {
		super(instance, 14);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Sugar Cube"));
		}
	}
}
