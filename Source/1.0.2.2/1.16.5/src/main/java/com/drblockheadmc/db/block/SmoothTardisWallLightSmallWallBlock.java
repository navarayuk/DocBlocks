...
public class SmoothTardisWallLightSmallWallBlock extends DbModElements.ModElement {
	@ObjectHolder("db:smooth_tardis_wall_light_small_wall")
	public static final Block block = null;

	public SmoothTardisWallLightSmallWallBlock(DbModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_tardis_wall_light_small_wall");
		}
