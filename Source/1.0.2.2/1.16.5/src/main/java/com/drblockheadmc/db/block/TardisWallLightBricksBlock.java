...
public class TardisWallLightBricksBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_light_bricks")
	public static final Block block = null;

	public TardisWallLightBricksBlock(DbModElements instance) {
		super(instance, 215);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_light_bricks");
		}
