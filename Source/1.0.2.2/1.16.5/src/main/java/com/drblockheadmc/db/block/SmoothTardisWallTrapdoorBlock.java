...
public class SmoothTardisWallTrapdoorBlock extends DbModElements.ModElement {
	@ObjectHolder("db:smooth_tardis_wall_trapdoor")
	public static final Block block = null;

	public SmoothTardisWallTrapdoorBlock(DbModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_tardis_wall_trapdoor");
		}
