...
public class BuilderSmoothTardisWallLightBlock extends DbModElements.ModElement {
	@ObjectHolder("db:builder_smooth_tardis_wall_light")
	public static final Block block = null;

	public BuilderSmoothTardisWallLightBlock(DbModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("builder_smooth_tardis_wall_light");
		}
