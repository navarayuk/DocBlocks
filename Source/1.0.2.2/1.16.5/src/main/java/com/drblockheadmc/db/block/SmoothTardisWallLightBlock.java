...
public class SmoothTardisWallLightBlock extends DbModElements.ModElement {
	@ObjectHolder("db:smooth_tardis_wall_light")
	public static final Block block = null;

	public SmoothTardisWallLightBlock(DbModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_tardis_wall_light");
		}
