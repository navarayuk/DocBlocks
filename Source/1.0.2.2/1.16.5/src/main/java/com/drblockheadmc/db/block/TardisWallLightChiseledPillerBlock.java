...
public class TardisWallLightChiseledPillerBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_light_chiseled_piller")
	public static final Block block = null;

	public TardisWallLightChiseledPillerBlock(DbModElements instance) {
		super(instance, 225);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_light_chiseled_piller");
		}
