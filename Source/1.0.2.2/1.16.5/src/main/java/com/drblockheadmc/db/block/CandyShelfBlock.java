...
public class CandyShelfBlock extends DbModElements.ModElement {
	@ObjectHolder("db:candy_shelf")
	public static final Block block = null;

	public CandyShelfBlock(DbModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD, MaterialColor.BROWN).sound(SoundType.WOOD).hardnessAndResistance(1.5f, 1.5f)
					.setLightLevel(s -> 0).notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("candy_shelf");
		}
