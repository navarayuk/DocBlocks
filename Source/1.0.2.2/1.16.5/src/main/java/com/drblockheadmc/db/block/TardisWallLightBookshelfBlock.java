...
public class TardisWallLightBookshelfBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_light_bookshelf")
	public static final Block block = null;

	public TardisWallLightBookshelfBlock(DbModElements instance) {
		super(instance, 229);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_light_bookshelf");
		}
