...
public class TardisWallLightTrapdoorBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_light_trapdoor")
	public static final Block block = null;

	public TardisWallLightTrapdoorBlock(DbModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_light_trapdoor");
		}
