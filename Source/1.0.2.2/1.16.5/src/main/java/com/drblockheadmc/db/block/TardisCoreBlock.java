...
public class TardisCoreBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_core")
	public static final Block block = null;

	public TardisCoreBlock(DbModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS, MaterialColor.GRASS).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f)
					.setLightLevel(s -> 15).notSolid().setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true)
					.setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y).with(WATERLOGGED, false));
			setRegistryName("tardis_core");
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			world.getPendingBlockTicks().scheduleTick(pos, this, 120);
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			TardisCoreUpdateTickProcedure.executeProcedure(Stream
