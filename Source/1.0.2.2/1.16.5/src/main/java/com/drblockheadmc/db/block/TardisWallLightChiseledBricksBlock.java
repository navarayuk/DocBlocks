...
public class TardisWallLightChiseledBricksBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_light_chiseled_bricks")
	public static final Block block = null;

	public TardisWallLightChiseledBricksBlock(DbModElements instance) {
		super(instance, 218);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_light_chiseled_bricks");
		}
