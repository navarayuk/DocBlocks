...
package com.drblockheadmc.db.world.biome;
...
public class EmptyBiome extends DbModElements.ModElement {
	public static Biome biome;

	public EmptyBiome(DbModElements instance) {
		super(instance, 144);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("db:empty"));
			}
		}
	}
