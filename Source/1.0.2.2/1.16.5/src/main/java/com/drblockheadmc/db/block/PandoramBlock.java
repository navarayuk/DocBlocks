...
public class PandoramBlock extends DbModElements.ModElement {
	@ObjectHolder("db:pandoram")
	public static final Block block = null;

	public PandoramBlock(DbModElements instance) {
		super(instance, 2);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pandoram"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("db:pandoram"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS, MaterialColor.LIME).tickRandomly().doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0.01f, 2f).setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true)
					.speedFactor(1.4000000000000001f).setLightLevel(s -> 4));
			setRegistryName("pandoram");
		}
		...
		public boolean isValidPosition(BlockState blockstate, IWorldReader worldIn, BlockPos pos) {
			...
			return ground == this || (ground == Blocks.SAND || ground == Blocks.RED_SAND || ground == Blocks.GRASS_BLOCK || ground == Blocks.MYCELIUM
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			PandoramPlantRightClickedProcedure.executeProcedure(Stream
