...
public class SmoothTardisSmallWallDarkBlock extends DbModElements.ModElement {
	@ObjectHolder("db:smooth_tardis_small_wall_dark")
	public static final Block block = null;

	public SmoothTardisSmallWallDarkBlock(DbModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_tardis_small_wall_dark");
		}
