...
public class CardboardTrapdoorBlock extends DbModElements.ModElement {
	@ObjectHolder("db:cardboard_trapdoor")
	public static final Block block = null;

	public CardboardTrapdoorBlock(DbModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("cardboard_trapdoor");
		}
