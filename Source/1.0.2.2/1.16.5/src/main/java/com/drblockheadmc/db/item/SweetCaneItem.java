...
public class SweetCaneItem extends DbModElements.ModElement {
	@ObjectHolder("db:sweet_cane")
	public static final Item block = null;

	public SweetCaneItem(DbModElements instance) {
		super(instance, 8);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(DocBlocksItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(4).saturation(2f).setAlwaysEdible().meat().build()));
			setRegistryName("sweet_cane");
		}
