...
public class BuilderSmoothTardisWellDarkBlock extends DbModElements.ModElement {
	@ObjectHolder("db:builder_smooth_tardis_well_dark")
	public static final Block block = null;

	public BuilderSmoothTardisWellDarkBlock(DbModElements instance) {
		super(instance, 52);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("builder_smooth_tardis_well_dark");
		}
