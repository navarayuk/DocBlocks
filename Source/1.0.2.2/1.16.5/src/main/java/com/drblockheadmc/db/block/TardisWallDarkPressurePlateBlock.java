...
public class TardisWallDarkPressurePlateBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_dark_pressure_plate")
	public static final Block block = null;

	public TardisWallDarkPressurePlateBlock(DbModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_dark_pressure_plate");
		}
