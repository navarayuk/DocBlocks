...
public class SmoothWallLightSlabBlock extends DbModElements.ModElement {
	@ObjectHolder("db:smooth_wall_light_slab")
	public static final Block block = null;

	public SmoothWallLightSlabBlock(DbModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_wall_light_slab");
		}
