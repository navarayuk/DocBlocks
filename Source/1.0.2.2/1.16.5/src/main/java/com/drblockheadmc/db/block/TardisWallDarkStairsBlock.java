...
public class TardisWallDarkStairsBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_dark_stairs")
	public static final Block block = null;

	public TardisWallDarkStairsBlock(DbModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_dark_stairs");
		}
