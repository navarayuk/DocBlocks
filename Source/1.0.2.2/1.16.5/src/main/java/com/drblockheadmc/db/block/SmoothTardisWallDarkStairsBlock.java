...
public class SmoothTardisWallDarkStairsBlock extends DbModElements.ModElement {
	@ObjectHolder("db:smooth_tardis_wall_dark_stairs")
	public static final Block block = null;

	public SmoothTardisWallDarkStairsBlock(DbModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_tardis_wall_dark_stairs");
		}
