...
public class HeartOfCaneItem extends DbModElements.ModElement {
	@ObjectHolder("db:heart_of_cane")
	public static final Item block = null;

	public HeartOfCaneItem(DbModElements instance) {
		super(instance, 19);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The sugar is strong with this one."));
		}
	}
}
