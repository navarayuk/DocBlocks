...
public class TardisWallDarkSlabBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_dark_slab")
	public static final Block block = null;

	public TardisWallDarkSlabBlock(DbModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_dark_slab");
		}
