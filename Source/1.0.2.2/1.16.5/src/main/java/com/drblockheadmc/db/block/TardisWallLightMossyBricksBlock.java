...
public class TardisWallLightMossyBricksBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_light_mossy_bricks")
	public static final Block block = null;

	public TardisWallLightMossyBricksBlock(DbModElements instance) {
		super(instance, 216);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_light_mossy_bricks");
		}
