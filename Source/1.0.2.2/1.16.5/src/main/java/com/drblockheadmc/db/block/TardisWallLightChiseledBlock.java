...
public class TardisWallLightChiseledBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_light_chiseled")
	public static final Block block = null;

	public TardisWallLightChiseledBlock(DbModElements instance) {
		super(instance, 217);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_light_chiseled");
		}
