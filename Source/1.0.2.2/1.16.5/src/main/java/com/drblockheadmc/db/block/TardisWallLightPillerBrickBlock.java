...
public class TardisWallLightPillerBrickBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_light_piller_brick")
	public static final Block block = null;

	public TardisWallLightPillerBrickBlock(DbModElements instance) {
		super(instance, 214);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_light_piller_brick");
		}
