...
public class SmoothTardisWallDarkBlock extends DbModElements.ModElement {
	@ObjectHolder("db:smooth_tardis_wall_dark")
	public static final Block block = null;

	public SmoothTardisWallDarkBlock(DbModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_tardis_wall_dark");
		}
