...
public class TardisWallDarkSmallWallBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_dark_small_wall")
	public static final Block block = null;

	public TardisWallDarkSmallWallBlock(DbModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_dark_small_wall");
		}
