...
public class SugarcaneAndBottleItem extends DbModElements.ModElement {
	@ObjectHolder("db:sugarcane_and_bottle")
	public static final Item block = null;

	public SugarcaneAndBottleItem(DbModElements instance) {
		super(instance, 27);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sugarcane_and_bottle");
		}
