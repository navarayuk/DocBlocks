...
public class BuilderTardisWallDarkBlock extends DbModElements.ModElement {
	@ObjectHolder("db:builder_tardis_wall_dark")
	public static final Block block = null;

	public BuilderTardisWallDarkBlock(DbModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("builder_tardis_wall_dark");
		}
