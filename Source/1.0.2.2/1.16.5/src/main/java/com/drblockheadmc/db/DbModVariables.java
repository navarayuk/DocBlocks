...
public class DbModVariables {
	public DbModVariables(DbModElements elements) {
	...
	public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		if (!event.getPlayer().world.isRemote()) {
			...
			if (mapdata != null)
				DbMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) event.getPlayer()),
	...
	public static class WorldVariables extends WorldSavedData {
		...
		public void syncData(IWorld world) {
			...
			if (world instanceof World && !world.isRemote())
				DbMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(((World) world)::getDimensionKey), new WorldSavedDataSyncMessage(1, this));
		}
	...
	public static class MapVariables extends WorldSavedData {
		...
		public void syncData(IWorld world) {
			this.markDirty();
			if (world instanceof World && !world.isRemote())
				DbMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new WorldSavedDataSyncMessage(0, this));
		}
	...
	private static class PlayerVariablesStorage implements Capability.IStorage<PlayerVariables> {
		...
		public INBT writeNBT(Capability<PlayerVariables> capability, PlayerVariables instance, Direction side) {
			...
			nbt.putBoolean("s9spam", instance.s9spam);
			nbt.putDouble("s9tick", instance.s9tick);
			nbt.putBoolean("GameModeC", instance.GameModeC);
			nbt.putDouble("LoadStoneX", instance.LoadStoneX);
			nbt.putDouble("LoadStoneY", instance.LoadStoneY);
			nbt.putDouble("LoadStoneZ", instance.LoadStoneZ);
			nbt.putBoolean("wastardis", instance.wastardis);
			nbt.putInt("directionsend", instance.directionsend.getIndex());
			nbt.putInt("PlaceD", instance.PlaceD.getIndex());
			nbt.putDouble("PlaceN", instance.PlaceN);
			nbt.putDouble("PlaceX", instance.PlaceX);
			nbt.putDouble("PlaceY", instance.PlaceY);
			nbt.putDouble("PlaceZ", instance.PlaceZ);
			return nbt;
		}
		...
		public void readNBT(Capability<PlayerVariables> capability, PlayerVariables instance, Direction side, INBT inbt) {
			...
			instance.s9spam = nbt.getBoolean("s9spam");
			instance.s9tick = nbt.getDouble("s9tick");
			instance.GameModeC = nbt.getBoolean("GameModeC");
			instance.LoadStoneX = nbt.getDouble("LoadStoneX");
			instance.LoadStoneY = nbt.getDouble("LoadStoneY");
			instance.LoadStoneZ = nbt.getDouble("LoadStoneZ");
			instance.wastardis = nbt.getBoolean("wastardis");
			instance.directionsend = Direction.byIndex(nbt.getInt("directionsend"));
			instance.PlaceD = Direction.byIndex(nbt.getInt("PlaceD"));
			instance.PlaceN = nbt.getDouble("PlaceN");
			instance.PlaceX = nbt.getDouble("PlaceX");
			instance.PlaceY = nbt.getDouble("PlaceY");
			instance.PlaceZ = nbt.getDouble("PlaceZ");
		}
	}
	...
	public static class PlayerVariables {
		...
		public void syncPlayerVariables(Entity entity) {
			if (entity instanceof ServerPlayerEntity)
				DbMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) entity), new PlayerVariablesSyncMessage(this));
		}
	}
