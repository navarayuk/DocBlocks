...
public class TardisWallLightSlabBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_light_slab")
	public static final Block block = null;

	public TardisWallLightSlabBlock(DbModElements instance) {
		super(instance, 63);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_light_slab");
		}
