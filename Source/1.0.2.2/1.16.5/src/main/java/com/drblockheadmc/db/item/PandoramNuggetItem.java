...
public class PandoramNuggetItem extends DbModElements.ModElement {
	@ObjectHolder("db:pandoram_nugget")
	public static final Item block = null;

	public PandoramNuggetItem(DbModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("pandoram_nugget");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Nugget of cane"));
		}
	}
}
