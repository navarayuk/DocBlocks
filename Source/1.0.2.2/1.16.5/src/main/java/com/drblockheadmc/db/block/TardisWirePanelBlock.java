...
public class TardisWirePanelBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wire_panel")
	public static final Block block = null;

	public TardisWirePanelBlock(DbModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).setLightLevel(s -> 7)
					.doesNotBlockMovement().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("tardis_wire_panel");
		}
