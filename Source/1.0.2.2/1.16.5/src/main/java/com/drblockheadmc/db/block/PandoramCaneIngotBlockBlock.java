...
public class PandoramCaneIngotBlockBlock extends DbModElements.ModElement {
	@ObjectHolder("db:pandoram_cane_ingot_block")
	public static final Block block = null;

	public PandoramCaneIngotBlockBlock(DbModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pandoram_cane_ingot_block");
		}
