...
public class TardisWallDarkBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_dark")
	public static final Block block = null;

	public TardisWallDarkBlock(DbModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_dark");
		}
