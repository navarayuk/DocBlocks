...
public class TardisMobScannerBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_mob_scanner")
	public static final Block block = null;

	public TardisMobScannerBlock(DbModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("tardis_mob_scanner");
		}
