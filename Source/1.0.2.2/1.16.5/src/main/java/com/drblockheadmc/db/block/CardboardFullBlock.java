...
public class CardboardFullBlock extends DbModElements.ModElement {
	@ObjectHolder("db:cardboard_full")
	public static final Block block = null;

	public CardboardFullBlock(DbModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("cardboard_full");
		}
