...
public class PandoramCaneIngotWallBlock extends DbModElements.ModElement {
	@ObjectHolder("db:pandoram_cane_ingot_wall")
	public static final Block block = null;

	public PandoramCaneIngotWallBlock(DbModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("pandoram_cane_ingot_wall");
		}
