...
public class TardisWallLightStairsBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_light_stairs")
	public static final Block block = null;

	public TardisWallLightStairsBlock(DbModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_light_stairs");
		}
