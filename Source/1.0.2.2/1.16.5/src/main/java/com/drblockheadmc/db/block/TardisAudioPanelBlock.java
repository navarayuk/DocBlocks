...
public class TardisAudioPanelBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_audio_panel")
	public static final Block block = null;

	public TardisAudioPanelBlock(DbModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("tardis_audio_panel");
		}
