...
public class QuantumCrystalBlockBlock extends DbModElements.ModElement {
	@ObjectHolder("db:quantum_crystal_block")
	public static final Block block = null;

	public QuantumCrystalBlockBlock(DbModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("quantum_crystal_block");
		}
