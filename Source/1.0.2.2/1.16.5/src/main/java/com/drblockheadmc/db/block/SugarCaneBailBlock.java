...
public class SugarCaneBailBlock extends DbModElements.ModElement {
	@ObjectHolder("db:sugar_cane_bail")
	public static final Block block = null;

	public SugarCaneBailBlock(DbModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.CLOTH).hardnessAndResistance(1f, 6f).setLightLevel(s -> 0));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("sugar_cane_bail");
		}
