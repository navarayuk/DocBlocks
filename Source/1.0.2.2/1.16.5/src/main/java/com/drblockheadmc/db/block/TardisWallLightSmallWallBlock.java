...
public class TardisWallLightSmallWallBlock extends DbModElements.ModElement {
	@ObjectHolder("db:tardis_wall_light_small_wall")
	public static final Block block = null;

	public TardisWallLightSmallWallBlock(DbModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("tardis_wall_light_small_wall");
		}
