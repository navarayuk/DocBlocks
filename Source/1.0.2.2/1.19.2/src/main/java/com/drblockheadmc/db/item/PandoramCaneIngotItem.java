...
public class PandoramCaneIngotItem extends Item {
	public PandoramCaneIngotItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("This ingot"));
		list.add(Component.literal("is so sweet"));
	}
}
