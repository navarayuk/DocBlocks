...
public class mcreator_sweetCane extends testenvironmentmod.ModElement {

	public static Item block;
	static {
		block = (Item) (new CustomItemFood(2, 0.3F, true)).setAlwaysEdible();
	}
	...
	public void load(FMLInitializationEvent event) {
		if (event.getSide() == Side.CLIENT)
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(block, 0, new ModelResourceLocation("testenvironmentmod:sweetcane", "inventory"));
	}
	...
	public static class CustomItemFood extends ItemFood {
		...
		public CustomItemFood(int par2, float par3, boolean par4) {
			...
			setUnlocalizedName("sweetcane");
			setRegistryName("sweetcane");
