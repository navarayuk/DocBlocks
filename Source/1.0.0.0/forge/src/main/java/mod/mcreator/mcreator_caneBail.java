...
public class mcreator_caneBail extends testenvironmentmod.ModElement {

	public static Block block;
	static {
		block = new BlockCustom().setHardness(2F).setResistance(6F).setLightLevel(0F).setUnlocalizedName("canebail").setLightOpacity(255)
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		block.setRegistryName("canebail");
	...
	public void load(FMLInitializationEvent event) {
		if (event.getSide() == Side.CLIENT) {
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(Item.getItemFromBlock(block), 0, new ModelResourceLocation("testenvironmentmod:canebail", "inventory"));
		}
	}
