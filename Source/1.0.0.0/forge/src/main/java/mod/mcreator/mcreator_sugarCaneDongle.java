...
public class mcreator_sugarCaneDongle extends testenvironmentmod.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public ItemCustom() {
			...
			setRegistryName("sugarcanedongle");
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ,
			...
			int z = pos.getZ();
			{
				...
				mcreator_sugarCaneDongleRightClickedOnBlock.executeProcedure($_dependencies);
			}
