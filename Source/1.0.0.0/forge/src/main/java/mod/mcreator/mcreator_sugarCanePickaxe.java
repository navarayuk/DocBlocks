...
public class mcreator_sugarCanePickaxe extends testenvironmentmod.ModElement {

	public static Item block;
	static {
		Item.ToolMaterial enumt = EnumHelper.addToolMaterial("SUGARCANEPICKAXE", 3, 4000, 18, 8, 14);
		...
		block.setRegistryName("sugarcanepickaxe");
