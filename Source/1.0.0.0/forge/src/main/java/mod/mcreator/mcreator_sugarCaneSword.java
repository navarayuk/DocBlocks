...
public class mcreator_sugarCaneSword extends testenvironmentmod.ModElement {

	public static Item block;
	static {
		Item.ToolMaterial enumt = EnumHelper.addToolMaterial("SUGARCANESWORD", 4, 4000, 30, 7, 20);
		...
		block.setRegistryName("sugarcanesword");
